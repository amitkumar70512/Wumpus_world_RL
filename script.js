...
head.onmouseover=function(){
    console.log("mouse is on over")
    head.s
    document.getElementsByTagName('marquee').stop;
}

head.onmouseout="this.start();"
...
function onClick(id) {
    ...
    else if (flag == 1 || flag == 2 || flag==3)
    {
        ...
        wall.push(parseInt(parseInt(id) % 10));
        document.getElementById(id).innerHTML='<i class="fa-solid fa-robot"></i>';
        document.getElementById(id).setAttribute("style", "background-color: black ;color:white");
